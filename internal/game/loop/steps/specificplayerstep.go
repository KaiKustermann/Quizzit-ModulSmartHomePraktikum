...
func (s *SpecificPlayerStep) AddTransitionToDieRoll(gsDigitalCategoryRoll *CategoryDigitalRollStep, gsHybridDieCategoryRoll *CategoryHybridDieRollStep) {
...
func (s *SpecificPlayerStep) HandleMessage(managers managers.GameObjectManagers, envelope dto.WebsocketMessagePublish) (nextstep GameStepIf, success bool) {
