...
func LoadQuestions() (questions question.QuestionsInJson, success bool) {
	...
	log.Error(fmt.Sprintf(`Could not load questions! The application will look in the following places and take the first valid file:
	1. Path as specified by '%s'
...
func loadQuestionsFromEnvPath() (questions question.QuestionsInJson, success bool) {
...
func loadFromExecDir() (questions question.QuestionsInJson, success bool) {
...
func loadDevQuestions() (questions question.QuestionsInJson, success bool) {
...
func loadQuestionsFromRelativePath(relPath string) (questions question.QuestionsInJson, success bool) {
...
func loadQuestionsFromAbsolutePath(absPath string) (questions question.QuestionsInJson, success bool) {
